...
//
    ...
    override func didMove(to view: SKView) {
        ...
        bottomLine.size = CGSize(width: 375, height: 75)
...
//        kmScore = self.childNode(withName: "kmScoreNode") as! SKSpriteNode
//        kmScore.texture = SKTexture(imageNamed: "Km Score")
//        kmScore.zPosition = 2
//
//
//        lifeBar = self.childNode(withName: "lifeBarNode") as! SKSpriteNode
//        lifeBar.texture = SKTexture(imageNamed: "Green Life")
//        lifeBar.zPosition = 2
//
//
//        gasIcon = self.childNode(withName: "gasIconNode") as! SKSpriteNode
//        gasIcon.texture = SKTexture(imageNamed: "Gas Icon")
//        gasIcon.zPosition = 2
        
        
        addLives()
        
        starfield = SKEmitterNode(fileNamed: "bigClouds")
...
//        scoreLabel.fontName = "November"
//        scoreLabel.fontSize = 28
//        scoreLabel.fontColor = UIColor.black
//        scoreLabel.isHidden = true
//        score = 0
//        //timerLabel.attributedText?.setValue(20.0, forKeyPath: NSAttributedStringKey.kern.rawValue)
...
//
        ...
        timerLabel.fontSize = 12.5
        timerLabel.fontColor = UIColor.black
       // timerLabel.addCharacterSpacing(kernValue: 1.3)
        
        //timerLabel.defaultTextAttributes.updateValue(20.0, forKey: NSAttributedStringKey.kern.rawValue)
      //  timerLabel.attributedText?.setValue(20.0, forKeyPath: NSAttributedStringKey.kern.rawValue)
...
//
    ...
    @objc func changeBackground() {
        ...
        case 182:
            ...
            self.backgroundColor=UIColor(red:0.65, green:0.25, blue:0.21, alpha:1.0) // De A33F35 a E3704
        ...
        case 200:
            ...
            self.backgroundColor=UIColor(red:0.79, green:0.55, blue:0.39, alpha:1.0)
            
        case 201:
            
            self.backgroundColor=UIColor(red:0.79, green:0.57, blue:0.43, alpha:1.0)
            
        case 202:
            
            self.backgroundColor=UIColor(red:0.79, green:0.60, blue:0.47, alpha:1.0)
        ...
        case 204:
            ...
            self.backgroundColor=UIColor(red:0.78, green:0.64, blue:0.55, alpha:1.0)
            
        case 205:
            
            self.backgroundColor=UIColor(red:0.78, green:0.66, blue:0.59, alpha:1.0)
            
        case 206:
            
            self.backgroundColor=UIColor(red:0.78, green:0.68, blue:0.63, alpha:1.0) //Termina C98659-C4B6AA
            
        case 207:
            
            self.backgroundColor=UIColor(red:0.77, green:0.71, blue:0.67, alpha:1.0) // De C4B6AA a BBC2CE
            
            
            
        case 210:
            
            self.backgroundColor=UIColor(red:0.75, green:0.72, blue:0.70, alpha:1.0)
            
        case 212:
            
            self.backgroundColor=UIColor(red:0.74, green:0.73, blue:0.74, alpha:1.0)
            
        case 214:
            
            self.backgroundColor=UIColor(red:0.73, green:0.75, blue:0.77, alpha:1.0)
            
        case 215:
            
            self.backgroundColor=UIColor(red:0.71, green:0.76, blue:0.81, alpha:1.0) // Termina C4B6AA-BBC2CE
...
//    }
    ...
    func fireTorpedo() {
        self.run(SKAction.playSoundFileNamed("sfxBlaster.mp3", waitForCompletion: false))
    ...
    func torpedoDidCollideWithAlien (torpedoNode:SKSpriteNode, alienNode:SKSpriteNode) {
        ...
        self.run(SKAction.playSoundFileNamed("sfxExplosion.mp3", waitForCompletion: false))
